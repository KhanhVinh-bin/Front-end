...
export default function GiangVienKhoaHocCaiDatPage() {
  ...
  return (
    <div className="gv-dashboard-root">
      {/* Header topbar theo mẫu giảng viên */}
              ...
              <div className="gvc-summary-card green">
                <div className="icon" aria-hidden="true">
                  <svg viewBox="0 0 24 24" fill="none">
                    <path d="M1 12s4-7 11-7 11 7 11 7-4 7-11 7-11-7-11-7Z" stroke="#22c55e" strokeWidth="2" />
              ...
              <div className="gvc-summary-card orange">
                <div className="icon" aria-hidden="true">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <g>
                      <path
                        d="M2 22 a8 8 0 1 1 16 0 h-2 a6 6 0 1 0-12 0 H2 z m8-9 c-3.315 0-6-2.685-6-6 s2.685-6 6-6 6 2.685 6 6-2.685 6-6 6 z m0-2 c2.21 0 4-1.79 4-4 s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4 z m8.284 3.703 A8.002 8.002 0 0 1 23 22 h-2 a6.001 6.001 0 0 0-3.537-5.473 l.82-1.824 z m-.688-11.29 A5.5 5.5 0 0 1 21 8.5 a5.499 5.499 0 0 1-5 5.478 v-2.013 a3.5 3.5 0 0 0 1.041-6.609 l.555-1.943 z"
                      />
                    </g>
                  </svg>
                </div>
            ...
            <div className="gvc-settings">
              <div className="gvc-settings-group">
                ...
                <div className="gvc-settings-row">
                  <label className="gvc-settings-label">Tiêu đề khóa học</label>
                  <input
                    className="gvc-settings-input"
                ...
                <div className="gvc-settings-row">
                  <label className="gvc-settings-label">Mô tả</label>
                  <textarea
                    className="gvc-settings-textarea"
                ...
                <div className="gvc-settings-row two-cols">
                  <div className="gvc-settings-col">
                    <label className="gvc-settings-label">Danh mục</label>
                    <select
                      className="gvc-settings-select"
                      value={category}
                  ...
                  <div className="gvc-settings-col">
                    <label className="gvc-settings-label">Cấp độ</label>
                    <select
                      className="gvc-settings-select"
                      value={level}
