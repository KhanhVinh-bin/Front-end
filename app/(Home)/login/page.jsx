        ...
        <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-xl shadow-lg p-8 zoom-in">
            ...
            <div className="text-center mb-8">
              ...
              {/* Toggle Buttons (đồng đều, không đè logo) */}
              <div className="flex bg-gray-100 rounded-full p-1 w-64 mx-auto justify-between mb-6">
                <Link href="/login" className="w-4/6 text-center py-2 bg-black text-white rounded-full transition">
                  Đăng nhập
                </Link>
                <Link href="/register" className=" text-center py-2 text-gray-700 hover:bg-gray-200 rounded-full transition">
                  Đăng ký
                </Link>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full pl-10 pr-12 py-3 bg-gray-200 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#7c3aed] focus:border-transparent"
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
