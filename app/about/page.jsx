...
const stats = [
  { icon: Users, label: "Học viên", value: "8 tỷ+", color: "text-[#7c3aed]" },
  { icon: Target, label: "Khóa học", value: "100 tỷ+", color: "text-[#06b6d4]" },
  { icon: Award, label: "Giảng viên", value: "2", color: "text-[#10b981]" },
...
const team = [
  ...
  },
  {
    ...
    image: "/team-3.jpg",
    bio: "15 năm kinh nghiệm trong lĩnh vực giáo dục",
  },
  {
    name: "Phạm Văn D",
